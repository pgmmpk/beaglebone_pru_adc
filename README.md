...
Default value id `0xff`, which means that encoder is disabled.
...
Setting it to a low value opens possibility of spurious ticks generated by random analog noise.
